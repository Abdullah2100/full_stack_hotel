create database hotel_db CREATE TABLE Persons(
...
CREATE TABLE Users (
    ...
    CreatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP PersonID BIGINT PRIMARY KEY Persons(PersonID)
);
...
CREATE TABLE Employees (
    ...
    CreatedBy BIGINT NOT NULL REFERENCES Employees(EmployeeID),
);
